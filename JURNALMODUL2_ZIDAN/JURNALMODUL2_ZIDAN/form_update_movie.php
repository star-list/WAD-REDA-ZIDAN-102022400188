...
<body>
 ...
 <label>Genre </label> </div>  <div class="form-floating mb-3">
                    <!-- ====================4================= -->
                  ...
                  <input type="text" class="form-control" name="director" value="<?= htmlspecialchars($movie['director']) ?>" placeholder="Nama Sutradara" required>
                    <label>Sutradara</label> </div>
                <div class="form-floating mb-3">
                    <!-- ====================5================= -->
                    <!-- Isi attribute value gunakan (int) untuk tahun rilis -->
                    <input type="number" class="form-control" name="release_year" value="<?= (int)$movie['release_year'] ?>" placeholder="Tahun Rilis" min="1900" max="<?= date('Y'); ?>" required>      <label>Tahun Rilis</label>   </div>
